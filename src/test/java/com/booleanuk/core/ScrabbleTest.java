...
class ScrabbleTest {
    ...
    public void shouldGive0ForEmptyWords() {
        Alphabet myAlphabet = new EnglishAlphabet();
        Scrabble scrabble = new Scrabble(myAlphabet);
    ...
    public void shouldScoreRussianLetters() {
        Alphabet myAlphabet = new RussianAlphabet();
        Scrabble scrabble = new Scrabble(myAlphabet);
    ...
    public void shouldScoreGreekLetters() {
        Alphabet myAlphabet = new GreekAlphabet();
        Scrabble scrabble = new Scrabble(myAlphabet);
